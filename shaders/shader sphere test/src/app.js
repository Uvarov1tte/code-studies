...
const startApp = () => {
  ...
  material.uniforms.uTime = { type: 'f', value: 0.0 }
  material.uniforms.uRadius = {type: 'f', value: 0.5}
  material.uniforms.uTexture = {value: new THREE.TextureLoader().load(landscape)}
